...
%
\topic{Thema \enquote{Untersuchung des Stromverbrauchs von verschiedenen Algorithmen und deren Implementierung auf mobilen Geräten}}
%
\thesisAuthor{Niklas Kluge}
\authorDateOfBirth{27.06.1996}
\authorPlaceOfBirth{Wernigerode}
%
\handInDate{\DTMdate{2010-09-20}} %formatted custom date
%
...
\include{Content/beispiel}

% Include the other chapters
\include{Content/einleitung}
\include{Content/VerwendeteGeräteUndTools}
\include{Content/EnergieEffizientesMultithreading}
\include{Content/theoretischeGrundlagen}
\include{Content/implementierungDerApp}
\include{Content/experimentelleUntersuchung}
...
\include{Content/anhang} % include the appendix
\end{document}
% ----------------------------------------------------